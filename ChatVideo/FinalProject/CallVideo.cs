...
namespace FinalProject
{
    public partial class CallVideo : Form
    {
                    ...
                    while (true)
                    {
                        ...
                        try
                        {
                            ...
                            if (bytesReceived > 0 && isCall)
                            {
                                ...
                                // Chuyển đổi dữ liệu byte về Bitmap
                                Bitmap originalBitmap = ByteArrayToBitmap(buffer);
                                ...
                                {
                                    ptb_otherCall.Image = originalBitmap;
                                }
                                else
                                {
        ...
        private void StopMicrophone()
        {
            ...
            {
                // Xử lý ngoại lệ
                MessageBox.Show($"Lỗi khi tắt mic: {ex.Message}", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
